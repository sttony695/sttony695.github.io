...
var science_labels = ['astronomy', 'theology', 'voidSpace', 'navigation', 'architecture', 'physics', 'chemistry', 'archeology', 'electricity', 'biology'];
...
function autoResearch() {
    if (gamePage.tabs[2].visible) {
        ...
        GlobalMsg['science'] = ''
	let ignores = ["paradoxalKnowledge"];
